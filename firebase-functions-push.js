/**
 * Firebase Cloud Function für Push-Benachrichtigungen
 * Deploy: firebase deploy --only functions
 * Vorher: firebase init functions (falls noch nicht)
 *
 * Diese Datei in functions/index.js kopieren oder als Referenz nutzen.
 */
...
exports.sendPushOnNotif = functions.firestore
  ...
  .onCreate(async (snap, ctx) => {
    ...
    if (lessonNum) parts.push('درس ' + lessonNum);
